...
class XPlaneConnect(object):
    ...
    def __init__(self, xpHost='localhost', xpPort=49009, port=0, timeout=100):
        ## original port = 49009 . Not sure where I see this. Thought that 49707 should be the port used
        # Appears that based on XPlaneConnect wiki, port 49009 is used by the plugin
